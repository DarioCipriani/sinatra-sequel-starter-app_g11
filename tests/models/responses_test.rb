...
class ResponseTest < MiniTest::Unit::TestCase
  ...
  def test_response_has_one_survey
    ...
    question = Question.create(name: 'Me gusta conocer los Procesos de las Empresas.', number: 1, type: 'radio',
                               description: '1')
    ...
    # seria como assert_equal(falla, response_duplicated.save() )
    assert_raises(Sequel::ValidationFailed) do
      response_duplicated.save
    end
