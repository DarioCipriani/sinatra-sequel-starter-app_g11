...
q2 = Question.create(name:'Tengo buena memoria y no me cuesta estudiar y retener fórmulas y palabras técnicas.', number:2, type:'radio', description:'2')
q3 = Question.create(name:'Me gusta escribir. En general mis trabajos son largos y están bien organizados.', number:3, type:'radio', description:'3')
q4 = Question.create(name:'Sé quien es Steven Hawking: Conozco y me atraen sus descubrimientos.', number:4, type:'radio', description:'4')
q5 = Question.create(name:'Me actualizo respecto de los avances tecnológicos y me intereso por investigar y conocer', number:5, type:'radio', description:'5')
q6 = Question.create(name:'Sé quien es Andy Warhol y a qué movimiento artístico pertenece. Me apasiona conocer acerca del arte y sus exponentes.', number:6, type:'radio', description:'6')
q7 = Question.create(name:'En general me intereso por las dificultades que ha tenido que atravesar la humanidad y cómo lo ha superado.', number:7, type:'radio', description:'7')
q8 = Question.create(name:'Me apasiona leer y no me importa si el libro que elijo tiene muchas páginas, para mí es un gran entretenimiento.', number:8, type:'radio', description:'8')
q9 = Question.create(name:'Me atrae conocer los procesos y las áreas que hacen funcionar a las empresas.', number:9, type:'radio', description:'9')
q10 = Question.create(name:'Me siento identificado con el pensamiento de algunos filósofos y escritores.', number:10, type:'radio', description:'10')
q11 = Question.create(name:'Me encanta estudiar el cuerpo humano y conocer cómo funciona. Además, no me impresiona la sangre.', number:11, type:'radio', description:'11')
q12 = Question.create(name:'Si pudiera elegir, pasaría mucho tiempo diseñando novedosos objetos o edificios en mi computadora.', number:12, type:'radio', description:'12')
q13 = Question.create(name:'Si mi blog fuera temático, trataría acerca de:', number:13, type:'radio', description:'13')
q14 = Question.create(name:'Integraría un equipo de trabajo encargado de producir un audiovisual sobre:', number:14, type:'radio', description:'14')
...
ch25 = Choice.create(text:'1. La importancia de la expresión artística en el desarrollo de la identidad de los pueblos.', question_id:q13.id)
ch26 = Choice.create(text:'2. La arquelogía urbana como forma de aprender acerca de la historia cultural de una ciudad.', question_id:q13.id)
ch27 = Choice.create(text:'3. La tecnología satelital en un proyecto para descubrir actividad volcánica para prevenir catástrofes climáticas.', question_id:q13.id)
ch28 = Choice.create(text:'4. Ninguna de las opciones.', question_id:q13.id)
ch29 = Choice.create(text:'1. La práctica de deportes y su influencia positiva en el estado de ánimo de las personas.', question_id:q14.id)
ch30 = Choice.create(text:'2. Los pensadores del siglo XX y su aporte a la gestión de las organizaciones.', question_id:q14.id)
ch31 = Choice.create(text:'3. Las mascotas y su incidencia en la calidad de vida de las personas no videntes.', question_id:q14.id)
ch32 = Choice.create(text:'4. El uso de la PC como herramienta para el control de los procesos industriales.', question_id:q14.id)
